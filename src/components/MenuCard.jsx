...
export default function MenuCard({ menu, onViewDetails, onAddToCart }) {
  if (!menu) return null;
  ...
  return (
    <div className="flex flex-col bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden w-full max-w-sm transition-all duration-300 hover:shadow-lg group">
      ...
      <div className="p-4 flex justify-between items-center mt-auto pt-3 border-t border-gray-200 dark:border-gray-700">
        <span
